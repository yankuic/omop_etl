...
select person_id = b.person_id
    ...
    ,value_as_number = try_convert(INT, a.tidal_volume_exhaled)
    ...
    ,source_table = 'measurement_res_tidal_spont'
from stage.MEASUREMENT_Res_Tidal_Spont a
join xref.person_mapping b
on a.patient_key = b.patient_key
left join xref.provider_mapping c 
on c.providr_key = isnull(a.attending_provider, a.visit_provider) and c.providr_key > 0
left join xref.source_to_concept_map d 
on source_code = 'TIDAL VOLUME - Spontaneous' and source_vocabulary_id = 'Flowsheet'
