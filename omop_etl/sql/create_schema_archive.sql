...
--HINT DISTRIBUTE ON KEY (person_id)
 CREATE TABLE archive.OBSERVATION_PERIOD (
...
--HINT DISTRIBUTE ON KEY (person_id)
 CREATE TABLE archive.VISIT_OCCURRENCE (
...
--HINT DISTRIBUTE ON KEY (person_id)
 CREATE TABLE archive.VISIT_DETAIL (
...
--HINT DISTRIBUTE ON KEY (person_id)
 CREATE TABLE archive.CONDITION_OCCURRENCE (
...
--HINT DISTRIBUTE ON KEY (person_id)
 CREATE TABLE archive.DRUG_EXPOSURE (
...
--HINT DISTRIBUTE ON KEY (person_id)
 CREATE TABLE archive.PROCEDURE_OCCURRENCE (
...
--HINT DISTRIBUTE ON KEY (person_id)
 CREATE TABLE archive.DEVICE_EXPOSURE (
...
--HINT DISTRIBUTE ON KEY (person_id)
 CREATE TABLE archive.MEASUREMENT (
...
--HINT DISTRIBUTE ON KEY (person_id)
 CREATE TABLE archive.OBSERVATION (
...
--HINT DISTRIBUTE ON RANDOM
 CREATE TABLE archive.FACT_RELATIONSHIP (
...
--HINT DISTRIBUTE ON RANDOM
 CREATE TABLE archive.CARE_SITE (
...
--HINT DISTRIBUTE ON KEY (person_id)
 CREATE TABLE archive.PAYER_PLAN_PERIOD (
...
--HINT DISTRIBUTE ON KEY (person_id)
 CREATE TABLE archive.CONDITION_ERA (
...
--HINT DISTRIBUTE ON RANDOM
 CREATE TABLE archive.CDM_SOURCE (
...
--HINT DISTRIBUTE ON RANDOM
 CREATE TABLE archive.COHORT_DEFINITION (
...
--HINT DISTRIBUTE ON RANDOM
 CREATE TABLE archive.ATTRIBUTE_DEFINITION (
