...
select visit_occurrence_id 
      ...
      ,visit_type_concept_id = isnull(visit_type_concept_id, 0)
      ,provider_id
      ,care_site_id 
      ,visit_source_value
...
select [condition_occurrence_id]
      ...
      ,condition_type_concept_id = isnull([condition_type_concept_id], 0)
      ,[stop_reason]
      ,[provider_id]
      ,[visit_occurrence_id]
      ,[visit_detail_id]
...
select procedure_occurrence_id
    ...
    ,procedure_type_concept_id = isnull([procedure_type_concept_id], 0)
...
select drug_exposure_id 
      ...
      ,drug_type_concept_id = isnull(drug_type_concept_id, 0)
      ,stop_reason
      ,refills
      ,quantity
      ,days_supply
...
SELECT observation_period_id
      ...
      ,period_type_concept_id = isnull([period_type_concept_id], 0)
...
select device_exposure_id
      ...
      ,device_type_concept_id = isnull([device_type_concept_id], 0)
      ,[unique_device_id]
      ,[quantity]
      ,[provider_id]
      ,[visit_occurrence_id]
...
select [provider_id]
      ...
      ,specialty_source_concept_id = isnull([specialty_source_concept_id], 0)
...
select condition_era_id
      ,a.person_id
      ,condition_concept_id = isnull(condition_concept_id, 0)
...
select drug_era_id
      ,a.person_id
      ,drug_concept_id = isnull(drug_concept_id, 0)
