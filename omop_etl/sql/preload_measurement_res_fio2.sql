...
select distinct 
      ...
      ,unit_source_value = '%'
      ,value_source_value = a.FIO2
      ,source_table = 'measurement_res_fio2'
from stage.measurement_res_fio2 a 
join xref.person_mapping b
on a.patient_key = b.patient_key
left join xref.provider_mapping c 
on c.providr_key = isnull(a.Attending_Provider, a.Visit_Provider)
left join xref.source_to_concept_map d 
on source_code = 'FIO2' and source_vocabulary_id = 'Flowsheet'
