...
#    Global variables
s_host = 'EDW.shands.ufl.edu'
s_db = 'DWS_PROD'
s_db_md = 'DWS_METADATA'

s_host_clar = 'CLREPIC02.shands.ufl.edu'
s_db_clar = 'CLARITY'

root_dir = r'\\shandsdfs.shands.ufl.edu\FILES\SHARE\DSS\IDR_Projects\OMOP'

s_yaml_file = r'\\shandsdfs.shands.ufl.edu\FILES\SHARE\DSS\IDR_Projects\authsettings\settings.yaml'
